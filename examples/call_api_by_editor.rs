...
use common::strategy::Editor;

type ExampleSessionFactory = SessionFactory<Editor>;
...
async fn main() -> Result<(), std::io::Error> {
    ...
    common::client::call_editor_handle(&session_id)
        .await
        .unwrap();
    ...
    common::client::call_forbidden("/admin_handle", &session_id)
        .await
        .unwrap();
